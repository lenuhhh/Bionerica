/**
 * Bionerika Agency — SVG Icon Library
 * Usage: <Icon name="phone" size={20} color="currentColor" />
 */
...
const PATHS = {
  ...
  order:      <><path d="M6 2L3 6h18l-3-4H6zM3 6h18v14H5V6H3z"/><path d="M16 10a4 4 0 0 1-8 0"/></>,
  ...
  /* Features / advantages */
  leaf:       <path d="M12 2C6 2 3 7 3 12c0 3 1.5 5.5 4 7M12 2c6 0 9 5 9 10 0 3-1.5 5.5-4 7M12 2v20M7 7c2 1 4 3 5 5M17 7c-2 1-4 3-5 5"/>,
  ...
  recycle:    <><polyline points="1 4 1 10 7 10"/><polyline points="23 20 23 14 17 14"/><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4-4.64 4.36A9 9 0 0 1 3.51 15"/></>,
  ...
  sprout:     <><path d="M7 20h10"/><path d="M10 20c5.5-2.5.8-6.4 3-9"/><path d="M9.5 9.4c1.1.8 1.8 2.2 2.3 3.7-2 .4-3.5.4-4.8-.3-1.2-.6-2.3-1.9-3-4.2 2.8-.5 4.4 0 5.5.8z"/><path d="M14.1 6a7 7 0 0 1 1.1 4.8 4 4 0 0 1-4.8-.3"/></>,
  ...
  telegram:   <><path d="M22 2L11 13"/><path d="M22 2 15 22 11 13 2 9l20-7z"/></>,

  /* Steps / grow */
  seed:       <><path d="M7 20h10M10 20c5.5-2.5.8-6.4 3-9"/><path d="M9.5 9.4c1.1.8 1.8 2.2 2.3 3.7-2 .4-3.5.4-4.8-.3-1.2-.6-2.3-1.9-3-4.2 2.8-.5 4.4 0 5.5.8z"/><path d="M14.1 6a7 7 0 0 1 1.1 4.8 4 4 0 0 1-4.8-.3"/></>,
...
export default function Icon({ name, size = 20, color = 'currentColor', strokeWidth = 1.75, className = '', style = {} }) {
